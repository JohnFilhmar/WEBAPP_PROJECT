...
<body class="flex flex-col min-h-screen">
    ...
    <div class="container mx-auto p-8 text-center">
        <h1 class="text-4xl font-bold mb-8 border-t-4 mt-8 h-20 p-8">Terms of Services</h1>
        ...
        <h1 class="text-4xl font-bold mb-8 border-t-4 mt-8 h-20 p-8">Privacy & Policies</h1>
        <div class="grid grid-cols-1 md-grid-cols-2 lg:grid-cols-2 gap-8 border-t-4">
            <section class="mb-8">
